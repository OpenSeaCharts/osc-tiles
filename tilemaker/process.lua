...
function node_function()
    ...
    case = {
        ...
        beacon = function()
            ...
            Attribute("color", Find("seamark:beacon_cardinal:colour"))
        ...
        beacon_isolated_danger = function()
            ...
            Attribute("color", Find("seamark:beacon_isolated_danger:colour"))
        ...
        beacon_lateral = function()
            ...
            Attribute("color", Find("seamark:beacon_lateral:colour"))
        ...
        beacon_safe_water = function()
            ...
            Attribute("color", Find("seamark:beacon_safe_water:colour"))
        ...
        beacon_special_purpose = function()
            ...
            Attribute("color", Find("seamark:beacon_special_purpose:colour"))
        ...
        bridge = function()
            ...
            Attribute("color", Find("seamark:bridge:colour"))
        ...
        building = function()
            ...
            Attribute("color", Find("seamark:building:colour"))
        ...
        buoy_cardinal = function()
            ...
            Attribute("color", Find("seamark:buoy_cardinal:colour"))
        ...
        buoy_isolated_danger = function()
            Layer("buoy", false)
            Attribute("category", "isolated_danger")
            Attribute("color", Find("seamark:buoy_isolated_danger:colour"))
        ...
        buoy_lateral = function()
            ...
            Attribute("color", Find("seamark:buoy_lateral:colour"))
        ...
        buoy_safe_water = function()
            Layer("buoy", false)
            Attribute("category", "safe_water")
            Attribute("color", Find("seamark:buoy_safe_water:colour"))
        ...
        buoy_special_purpose = function()
            ...
            Attribute("color", Find("seamark:buoy_special_purpose:colour"))
        ...
        daymark = function()
            ...
            Attribute("color", Find("seamark:daymark:colour"))
        ...
        landmark = function()
            ...
            Attribute("color", Find("seamark:landmark:colour"))
        ...
        light_float = function()
            ...
            Attribute("character", Find("seamark:light_float:character"))
            Attribute("color", Find("seamark:light_float:colour"))
        end,
        light_vessel = function()
            Layer("light", false)
            Attribute("color", Find("seamark:light_vessel:colour"))
        ...
        pile = function()
            ...
            Attribute("color", Find("seamark:pile:colour"))
        ...
        topmark = function()
            Layer("topmark", false)
            Attribute("color", Find("seamark:small_craft_facility:colour"))
